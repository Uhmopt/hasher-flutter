...
class EditHareRunForm extends StatefulWidget {
  EditHareRunForm(
      {Key? key,
      required this.run,
  ...
  @override
  _EditHareRunFormState createState() => _EditHareRunFormState();
}

class _EditHareRunFormState extends State<EditHareRunForm> {
  ...
  _initCoHare() {
    showLoading();
    getCoHares(hashrunid: widget.run.hashrunid).then((value) {
      setState(() {
        _coharenames = value;
      });
      SmartDialog.dismiss();
